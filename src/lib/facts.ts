...
export const OPEN_QUESTIONS: OpenQuestion[] = [
  ...
  },
  {
    id: 'q-operations',
    question:
      'По фотографиям видно сверлильный станок, точило, торцовочную пилу, деревообрабатывающий станок и ручной пресс. Какие из этих операций ты берёшь на заказ, а какие делаешь только для себя?',
    blocks:
      'Страница /detali-na-zakaz/ — сейчас нельзя перечислить, что именно можно изготовить.',
    area: 'производство',
  },
  {
    id: 'q-equipment-publish',
    question:
      'Можно ли публиковать список оборудования на сайте? Это сильный аргумент: у большинства конкурентов только сборка.',
    blocks: 'Раздел «Что здесь есть» на /o-mastere/.',
    area: 'производство',
  },
  {
    id: 'q-metal',
    question:
      'Ручной пресс и точило — это работа с металлом. Берёшь ли металлические детали: пластины, уголки, кронштейны, подгонку под размер?',
    blocks:
      'Потенциально отдельное направление, которого нет ни у кого из местных. Пока на сайте не упоминается.',
    area: 'производство',
  },
  {
    id: 'q-fasteners-stock',
    question:
      'На фотографиях большой разобранный запас крепежа. Можно ли обещать, что нужная мелочь часто находится сразу? И продаёшь ли ты фурнитуру отдельно, без работы?',
    blocks:
      'Блок «Половина задач решается тем, что нужная железка уже лежит в ящике» на главной и ответ в /furnitura/.',
    area: 'производство',
  },
  {
  ...
  },
  {
    id: 'q-photos',
    question:
      'Нужны кадры, которых пока нет: готовая мебель, работа на объекте, процесс (раскрой, сборка, установка петли) и хотя бы одна пара «до / после».',
    blocks:
      'Все изображения сайта. Сейчас стоят помеченные заглушки — см. docs/PHOTO-BRIEF.md, описание мастерской — docs/WORKSHOP-REFERENCE.md.',
    area: 'производство',
  },
  {
    id: 'q-first-projects',
    question:
      'Какие 3–5 последних работ можно описать и сфотографировать? Нужны: что просил клиент, что мешало, что сделали.',
    blocks:
      'Раздел /proekty/ — сейчас там только шаблоны. Каждая реальная работа даёт отдельную страницу в поиске.',
    area: 'производство',
  },
  {
    id: 'q-messengers',
